...
function PersonCreateForm({persons_gql}): ReactElement {
    const [createPerson] = useMutation(create_person_query, {
        refetchQueries: [persons_gql]
    });
